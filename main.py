    ...
    if st.session_state.vectorstore and st.session_state.chat_model:
        with st.chat_message("assistant"):
            with st.spinner("🔍 Searching Documents..."):
                ...
                relevent_docs = retrieve_relevant_docs(st.session_state.vectorstore, prompt)

                # Create context from relevent documents
                ...
                Based on the following medical documents, provide accurate and helpful answeres.
                If the information is not in the documents, clerly state that.
